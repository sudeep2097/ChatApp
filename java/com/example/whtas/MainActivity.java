...
/////////////////////////////////////////////////////////
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
              ...
              //  if (user.getImage().equals("default")){
                //    profile_image.setImageResource(R.drawable.friend);
                //}else {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (item.getItemId() == R.id.main_video_options)
        {
    ...
    private void RequestNewGroup()
    {
        ...
        groupNameField.setHint("eg. MyGroup");
    ...
    private void SendUserToVideoActivity() {
        //Intent findFriendsIntent = new Intent(MainActivity.this, LoginvActivity.class);
        //startActivity(findFriendsIntent);
    }
