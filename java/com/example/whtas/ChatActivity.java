...
import com.example.whtas.Notificaation.Client;
import com.example.whtas.Notificaation.Data;
import com.example.whtas.Notificaation.Sender;
import com.example.whtas.Notificaation.Token;
...
public class ChatActivity extends AppCompatActivity {
            ...
            if (!checker.equals("image"))
            {
                ...
                filePath.putFile(fileUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        ...
                        final String msg = task.getResult().getStorage().getDownloadUrl().toString();
                        ...
                        reference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                               ...
                               // for (DataSnapshot snapshot:dataSnapshot.getChildren())
                                ...
                                if (notify) {
                                    sendNotifiaction(userid, user.getImage(), msg);
                                }
                                notify = false;
                            }
   ...
   // private void sendNotifiaction(String userid, String image, String msg) {
    //}
